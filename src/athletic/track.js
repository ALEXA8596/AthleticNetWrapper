...
const track = {
    ...
    meet: {
        ...
        GetAllResultsData: async function (meetId) {
            ...
            const response = await fetch("https://www.athletic.net/api/v1/Meet/GetAllResultsData?rawResults=false&showTips=false", {
                "headers": {
                    "accept": "application/json, text/plain, */*",
        ...
        GetTeams: async function (meetId) {
            ...
            try {
                return fetch("https://www.athletic.net/api/v1/Meet/GetTeams", {
                    "headers": {
                        "accept": "application/json, text/plain, */*",
